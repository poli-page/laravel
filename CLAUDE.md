...
| Field        | Value |
| ------------ | ----- |
| Repository   | `poli-page/laravel` |
| Type         | Framework integration (Laravel) |
| Language     | PHP |
| Registry     | Packagist — `poli-page/laravel` |
...
- After adding a lint config (`Pint (Laravel) or PHP-CS-Fixer`), the lint step lights up.
...
- **Lint / format**: Pint (Laravel) or PHP-CS-Fixer
- **Manifest file**: `composer.json`
- **Run tests locally**: `vendor/bin/phpunit`
- **Run lint locally**: `vendor/bin/pint --test`
